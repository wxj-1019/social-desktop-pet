...
## <img src="assets/icons/star-sparkle.svg" width="24" alt=""> 这是什么
...
## <img src="assets/icons/constellation.svg" width="24" alt=""> 亮点
...
| 自建后端          | Postgres + Node（Hono HTTP + WebSocket + 自建 Auth），软件费 0             |

## <img src="assets/icons/paw.svg" width="24" alt=""> 签名角色：星屿
...
## <img src="assets/icons/compass.svg" width="24" alt=""> 星图（项目结构）
...
## <img src="assets/icons/terminal.svg" width="24" alt=""> 信号表（常用命令）
...
## <img src="assets/icons/shield.svg" width="24" alt=""> 安全与约定
...
## <img src="assets/icons/moon.svg" width="24" alt=""> 当前状态
...
## <img src="assets/icons/orbit.svg" width="24" alt=""> 参与贡献

每个功能该改哪个包，见 [AGENTS.md](AGENTS.md) 的"功能落点速查"表；8 条关键约定（类型单一真相源 / 图而非过程函数 / 数据库提交即真相 / RLS 纵深防御等）勿违反。

## <img src="assets/icons/scroll.svg" width="24" alt=""> 来源与许可
