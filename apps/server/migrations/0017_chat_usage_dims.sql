-- ============================================================================
-- 0017_chat_usage_dims.sql —— chat 用量成败/限流/模型维度（2026-08-18）
-- ============================================================================
...
-- model：当日最后使用的模型名（LlmClient.model；空串 = 骨架降级）
-- ============================================================================
...
alter table chat_usage add column if not exists model text not null default '';
