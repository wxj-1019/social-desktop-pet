        ...
        <g className="star-isle__rig">
          ...
          <g data-part="head" data-hit="head" className="star-isle__head">
            ...
            <ellipse
              ...
              opacity="0.32"
            />
            {/* 刘海（x 范围 96–184，中心 140 与头椭圆居中对齐——
                此前范围 86–174 中心 130，整体偏左 10px 导致"刘海错位"） */}
            <path
              className="star-isle__bangs"
              d="M 96 120 C 96 100 108 84 124 82 C 132 94 136 88 144 82 C 152 76 166 76 172 84 C 182 94 184 108 184 120 C 170 112 158 118 148 120 C 136 118 118 114 96 120 Z"
              fill={COLORS.innerEar}
            />
            {/* 额间光冠 */}
